...
Global $states[]=["mainMenu","battleMode","searchForOppoent","selectCard","playingCard","challenge","arenaMode0","arenaMode1","friendMode","buildingCard","buyingCard","checkForTasks","openCardPack","praticeMode","closed"];
...
Func mainLoop()
	...
	While 1
		...
		clickPics("button_ok0.bmp|button_ok1.bmp|button_ok2.bmp")
		Switch $state
			case "mainMenu"
...
Local $count=0;
updateCurPlayerStatus()
While $myPlayerStatus[$PS_NUM_HAND_CARDS]>0 And $count<=7
