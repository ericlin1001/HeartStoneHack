...
struct CardBuff{
	...
	Action action;//0:add 1:del 2:set 3:silence 4:select 5:return
	Type attr;//0:hit 1:hp 2:crystal 3:card 4:mock 5:armour 6:secret
	int num;
...
struct HandCard{
	int hit,hp,cost;
	bool isMock,isShield,isRush,isWind;
