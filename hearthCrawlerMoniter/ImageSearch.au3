...
If IsString($findImage) Then
	$result = DllCall("ImageSearchDLL.dll","str","ImageSearch@24","int",$x1,"int",$y1,"int",$right,"int",$bottom,"str",$findImage,"ptr",$HBMP)
Else
	$result = DllCall("ImageSearchDLL.dll","str","ImageSearch@24","int",$x1,"int",$y1,"int",$right,"int",$bottom,"ptr",$findImage,"ptr",$HBMP)
EndIf
